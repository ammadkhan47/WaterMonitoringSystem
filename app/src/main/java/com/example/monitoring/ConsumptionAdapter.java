...
public class ConsumptionAdapter extends ArrayAdapter<Member> {
     ...
     * @param objects
     */
    public ConsumptionAdapter(Context context, int resource, ArrayList<Member> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //ViewHolder object
        ConsumptionAdapter.ViewHolder holder;


        if(convertView == null){
            LayoutInflater inflater = LayoutInflater.from(mContext);
            convertView = inflater.inflate(mResource, parent, false);
            holder= new ConsumptionAdapter.ViewHolder();
            ...
            holder = (ConsumptionAdapter.ViewHolder) convertView.getTag();
            result = convertView;
        }
        ...
        holder.con.setText("Consumption: "+Member.getConsum()+"ml");
